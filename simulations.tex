...
\begin{exercise}
  Generate 100 random interarrival times for 3 customers, and plot the cdf of the merged process.
...
For this use \pyv{scipy.stats.norm}. What do you see?
\begin{solution}
Add this to the other code and run it. 
\begin{pyverbatim}
