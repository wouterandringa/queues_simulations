...
We initialize the arrival time and service time to zero, and we use the attributes \pyv{departure_time} and \pyv{queue_length_at_arrival} for a statistical analysis at the end of the simulation.
