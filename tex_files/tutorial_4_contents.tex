...
It is not a problem when you spend considerable time on this exercise. Most of the following exercises are simple numerical experiments, which should take little time. So, just try and see how far you get. All code is in the solution.

\begin{solution}
  Study this code in detail so that you really understand how it works.
...
\begin{solution}
    We study the dynamics of a queueing process in which the demand grows and then peters out. Such queueing situations are, typically, mathematically intractable. In fact, we finally have come to a point at which we really need simulation.
\begin{pyverbatim}
# empty code for numbering
\end{pyverbatim}
  \end{solution}
