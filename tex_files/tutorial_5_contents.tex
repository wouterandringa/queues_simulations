...
The result of this might be that in certain settings sharing is best (perhaps with relatively many business customers), and in others, it is better not to share.
...
\begin{solution}
    \begin{enumerate}
    \item First, check whether the simulator is indeed correct.
    ...
    \item Since there is a small number of business customers, why not open the business check-in desk later than the other desks?
